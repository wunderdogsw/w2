...
export default () => (
  <Fragment>
    ...
    <h2>
      ...
      <p id="register">Register to the event by filling in your e-mail below. This
      puts you to a waiting list. We aim to host as many attendees as possible. We will confirm your
      attendance few weeks prior to the event.</p>
      <HubspotForm
        portalId='1704241'
