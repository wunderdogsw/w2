...
export default () => (
  <Fragment>
    ...
    <Chapter>
      ...
      <p>
        It was the end of October 2016. The hazy and drizzly weather made Helsinki
        resemble the mean streets of some film noir movie. On the day in question,
        I was just finishing my workday: closing applications on my laptop before
        throwing it into my backpack and heading to out the door.
      </p>
      <BlockQuote>
        Service is fast, affordable, and comes with informed, actionable insights.
      </BlockQuote>
      <p>
